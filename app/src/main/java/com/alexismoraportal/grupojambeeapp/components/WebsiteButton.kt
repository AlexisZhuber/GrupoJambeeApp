...
fun WebsiteButton() {
    ...
    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://grupojaambe.com"))
        ...
        horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        Button(onClick = {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(text = "Pagina web")
                // Agrega un pequeño espacio entre el texto y el icono
                Spacer(modifier = Modifier.width(4.dp))
                Icon(painter = painterResource(R.drawable.baseline_web_24), contentDescription = "WhatsApp Logo", modifier = Modifier.size(20.dp)) // Ajusta el tamaño según necesites
            }
        }
    }
